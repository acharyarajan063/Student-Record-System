...
<nav class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <?php if($role == 'admin'): ?>
            ...
            <li>
                ...
                <?= ($current_page == 'admin_dashboard.php') ? 'class="active"' : '' ?>>
                    Dashboard
                </a>
            </li>
            ...
            <li>
                <a href="/Student-Record-System/05_Grade_management/grade_admin.php"
                <?= ($current_page == 'grade_admin.php') ? 'class="active"' : '' ?>>
                    Grades
                </a>
            </li>
    ...
    <div class="nav-profile">
        ...
        <a href="/Student-Record-System/logout.php"
           class="logout-btn">
